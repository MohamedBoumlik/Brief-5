...
<html lang="en">
  ...
  <body>
      ...
      <div id="salleForm" style="width: 70%; margin-left: 14%;">
        <p>
            <form action="http://localhost/mvc2/Brief-5/groupe/update/<?=$obj1['id']?>" method = "Post">
                
                <div id="inputs">

                    <div class="col-xs-6">
                        <label for="ex3">Name</label>
                        <input class="form-control" id="ex3" type="text" name="name" value="<?=$obj1['name']?>">
                    </div>

                    <div class="col-xs-6">
                        <label for="ex3">Effectif</label>
                        <input class="form-control" id="ex3" type="number" name="cap" value="<?=$obj1['cap']?>">
                    </div>
